...
const Login = () => {
  return (
    <>
      ...
      <div className="ml-4 mt-9 grid h-96 w-80 place-content-center text-center font-lato shadow-2xl md:container lg:mt-28 lg:h-[374px] lg:w-[544px]">
        <div>
          <p className=" font-josefin text-2xl font-bold md:text-4xl">Log In</p>
          <div className="text-sm text-slate-400">
            Please log in using account detail below.
          </div>
          <form className="mt-2 grid place-items-center gap-2 text-center">
            <input
